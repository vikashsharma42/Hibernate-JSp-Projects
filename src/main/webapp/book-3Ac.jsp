	...
	<div class="sl_container">
		<div class="sl_container_box">
			<div class="sl_box">
				...
				<hr>
				<strong class="sleeper-heading">AC 3 Tier (3A) | General</strong>
			...
			<form action="3Ac-booking-review.jsp" method="post" class="needs-validation" id="myForm" novalidate>
				...
				<div class="sl_contact">
					...
					<p>(Ticket details will be sent to email- <%=ema %>)</p>
					<%
	                    }
					%>
					<div class='row form-group'>
						<div class='col-md-3'>
						 ...
						 required />
							<div class="invalid-feedback" style="margin-left: 5rem;">Mobile number is Required.</div>
						</div>
					</div>
				</div>
