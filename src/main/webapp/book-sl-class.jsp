	...
	<div class="sl_container">
		<div class="sl_container_box">
			<div class="sl_box">
				...
				<hr>
				<strong class="sleeper-heading">Sleeper (SL) | General</strong>
			...
			<form action="sl-booking-review.jsp" method="post"
							...
							<div class='row form-group' style="margin-left: .5rem;">
								...
								<div class='col-md-2'>
									<input type='number' name="age" id='age' class='form-control'
										placeholder="Age" min="12" max="125"
				...
				<div class="sl_contact">
					...
					<div class='row form-group'>
						<div class='col-md-3'>
							<span>91</span> <input type='text' name="phone" id='phone'
								class='form-control' placeholder="Passenger Mobile Number*"
				...
				<div class="sl_insurance">
					<p>
						<strong>Travel Insurance (Incl. of GST)</strong> <small>Do
							you want to take Travel Insurance (&#x20B9;0.35/person)?</small>
					</p>
					<input type="radio" name="insurance" value="true" checked><span>Yes,
						and I accept the </span> <a target="blank" href="pdf/Insurance_T&C.pdf">terms
						and conditions</a> <input type="radio" name="insurance" value="false"
						style="margin-left: 8rem;"> <span>No, I don't want
