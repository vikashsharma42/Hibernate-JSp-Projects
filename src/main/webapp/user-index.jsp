				...
				<div class="d-flex flex-column" style="height: auto;">
					<div class="d-flex flex-wrap">
						<div class="d-flex text-center">
							<a href="flight.jsp" class="center-icons" target="blank">
							<i class="fa fa-plane fa-5x"></i></a>
							 <a href="hotel.jsp" class="center-icons" target="blank">
							 <i class="fa fa-hotel fa-5x"></i> </a> 
								<a href="#" class="center-icons" target="blank">
									<i class="fa-solid fa-arrow-trend-up fa-5x"></i></a>							 
							<a href="meal-list.jsp"  class="center-icons" target="blank"> 
							<i class="fa-solid fa-bowl-rice fa-5x"></i>
							</a> <a href="bus.jsp" class="center-icons" target="blank">
	...
	<div class="row"
		...
		<div class="col-md-12 offset-md-1  d-flex mt-4">
			<div class="col-md-3"
				...
				<div class="col-md-11">
					...
					<a href="maharaja_train.jsp" class="offset-md-1 mt-3 package-link" target="_blank">Read
			...
			<div class="col-md-3"
				...
				<div class="col-md-11">
					...
					<br> <a href="International_Packages.jsp" class="offset-md-1 mt-3 package-link"
			...
			<div class="col-md-3"
				...
				<div class="col-md-11">
					...
					<br> <a href="Domestic_Packages.jsp" class="offset-md-1 mt-3 package-link"
						target="_blank">Read More<i class="fa fa-arrow-right"
						aria-hidden="true"></i></a>
				</div>
				<br>
		...
		<div class="col-md-12 offset-md-1 d-flex mt-4">
			<div class="col-md-3"
				...
				<br> <a class="offset-md-1 mt-3 package-link" href="Bharat_Gaurav_Tourist_Train.jsp"
					target="_blank">Read More<i class="fa fa-arrow-right"
					aria-hidden="true"></i></a>
			</div>
			<div class="col-md-3"
				...
				<div class="col-md-11">
					...
					<a class="offset-md-1 mt-3 package-link" href="Rail_Tour_Packages.jsp" target="_blank">Read
						More</a><i class="fa fa-arrow-right" aria-hidden="true"></i>
				</div>
				<br>
			</div>
		</div>
