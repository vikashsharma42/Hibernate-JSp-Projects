...
<body>
	...
	<div class="logo3">
		...
		<div class="logos_heading">
			...
			<span style="border: 0px">Puncutality</span>
		</div>
		<div class="logo4">
			<form action="search-train.jsp" method="post" class="form_conatiner">
	...
	<div class="train_details">
		...
		<div class="train_details_card1">
			...
			<p class="train_details_card1_p">Redefining Royalty, Luxury and
				...
				Experience Unsurpassed. It has been a winner of a World Leading
				Luxury train by World Travel Awards consecutively for last six
				years.</p>
		...
		<div class="train_details_card4">
			...
			<p class="train_details_card1_p">IRCTC operates Bharat Gaurav
				...
				destinations in its itinerary on a 5 days to 20 days trip of Indias
