	...
	<div class="sl_Review">
		<div class="sl_Review_container">
			<div class="sl_Review_Box">
				...
				<div class="sl_Review_Box_Head_Container">
					<span><%=startTime%> | <strong><%=from%></strong> Mon, 12
						Feb</span>
					<p><%=totalTime%></p>
					<label><%=endTime%> | <strong><%=to%></strong> Tue, 13
						Feb</label> <b>available 000<%=seat%></b>
				</div>
				<div class="sl_Review_Box_subHead">
					<strong>1 Adult | Sleeper (SL) | General | Boarding at <%=from%>
						| Boarding Date: <%=session.getAttribute("date")%> 2024 <%=startTime%></strong>
				</div>
				<small>Please check <strong style="color: #0047AB;">NTES
						website</strong>or <strong style="color: #0047AB;">NTES app</strong> for
					actual time before boarding
				</small>
			</div>
			<div class="Review_Box">
				...
				<b>1 <%=name%></b> <small><%=age%> yrs | <%=gender%> | <%=country%>
				</small>
			</div>
			...
			%>
			<a href="pdf/Refundrule2015.pdf" target="anc_bt">View
				Cancellation Policy</a>
			<div class="Review_banner">
				<img src="register/right-banner.jpeg">
			</div>
			<form method="post" action="card.jsp" class="needs-validation"
				novalidate>
		...
		<div class="sl_Review_container_box">
			...
			<div class="sl_Review_container_child">
				<p>
					Ticket Fare<label style="margin-left: 10.5rem;">&#x20B9;</label><span
						id='ticketFare' style="margin-right: 2rem;"><%=price%></span>
				</p>
				<p>
					Convenience Fee (Incl. of GST)<label style="margin-left: 3rem;">&#x20B9;</label><span
						id='conFee' style="margin-right: 2.4rem;">15</span>
				</p>
				<P>
					Travel Insurance (Incl. of GST)<label>&#x20B9;</label><span
						id='insurance'>0.35</span>
				</P>
			</div>
			<div class="sl_Review_container_subchild">
				<p>
					Total Fare<label>&#x20B9;</label><span id='totalFare'></span>
				</p>
			</div>
			<div class="sl_Review_banner">
				<img src="register/ramayan.jpeg">
			</div>
		</div>
