	...
	<div class="sl_Review">
		<div class="sl_Review_container">
		  ...
		  <div class="sl_Review_Box_subHead">
		  	<strong>1 Adult | AC 2 Tier (2A) | General | Boarding at <%=from %> | Boarding Date: <%=session.getAttribute("date")%> 2024 <%=startTime %></strong>
		  </div>
		...
		<form method="post" action="2Ac-card.jsp" class="needs-validation" novalidate>
