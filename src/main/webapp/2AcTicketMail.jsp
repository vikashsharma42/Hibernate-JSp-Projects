...
session.removeAttribute("price");
	...
	double totalPrice=price+15+0.35;
	...
	if (email != null || email.equals("")) {
		...
		try {
			...
			msg.setSubject("Booking Confirmation on IRCTC, Train: "+trainNumber+", "+date+"-2024, SL, "+journeyFrom+" - "+journeyTo+"");
		   ...
		   +" This is a system generated mail. Please do not reply to this email ID. (1) Call our 24-hour Customer Care (2) Email"
				   +"Us at <small style='color:#0437F2;'>care@irctc.co.in</small>"
						   +"<hr style='width: 100.5%;'>"
								   +"</div>	"					   				
								   +" <div style='margin-left: .5rem; width: 100%;'>"
								   +"<small style='color: #0437F2'>Ticket Confirmation</small><br>"
										   +"<strong>"+ session.getAttribute("fname") +" " + session.getAttribute("lname")
										   +"(User Id:" + session.getAttribute("username")+"),</strong>"
                                  ...
                                  +" <div style='color:white; display: flex; margin-left: .5rem; width: 100%;'>"
                                		  +"   <div style='width: 15.6%; color: black;'>"
                                				  +"   <div>"
                                						  +"      <strong>PNR No. :</strong><br>"
                                													  +"    </div><hr>             "
                                								  +"    <div>"
						                    		...
						                    		+"       <hr>"
						                    				+"   </div>"
						                    						+"   <div>"
						                    								+"        <strong>Boarding At :</strong><br>"
						                    										+"        <hr>"
						                    												+"    </div>"
						                    														+"    <div>"
						                    																+"        <strong>Reservation Up to :</strong><br>"
						                    																		+"        <hr>"
						                    																				+"    </div>"
						                    																						+"  <div>"
						                    																								+"   <strong>Passenger Mobile No :</strong><br>"
						                    																										+"  <hr>"
						                    																												+" </div>"
						                    																														+"</div>"
						            
+" <div style='width: 15.6%;margin-left: .5rem; '>"
		+"      <div>"
				+"     <strong>"+pnr+"</strong><br>"
						+"       <hr>"
								+"      </div>"
										+"      <div>"
												+"        <strong>100000"+tId+"</strong><br>"
														+"        <hr>"
																+"    </div>"
																		+"     <div>"
																				+"       <strong>"+journeyTo+"</strong><br>"
																						+"       <hr>"
																								+"     </div>"
						            		+"   <div>"
						            		+"    <strong>"+journeyTo+"</strong><br>"
						                		...
						                		+"   </div>"
						                				+"   <div>"
									            		+"     <strong>"+journeyFrom+"</strong><br><hr>"
									              				+"   </div>"
						            		+"   <div>"
						            		+"     <strong>"+phone+"</strong><br>"
						                		+"       <hr>"
						                				+"   </div>"
						            		+"    </div>"
						        		+"    <div style='width: 15.6%;margin-left: .5rem ; color: black;'>"
						    		   +"   <div>"
						            		+"   <strong>Train No. :</strong><br>"
						                		+"     <hr>"
						                				+"     </div>"
						                						+"     <div>"
						                								+"        <strong>Time of Booking :</strong><br>"
						                										+"        <hr>"
						                												+"    </div>"
						                														+"    <div>"
						                																+"       <strong>Date of Journey :</strong><br>"
						                																+"      <hr>"
						                																		+"  </div>"
						                																				+"    <div>"
						                																						+"     <strong>Date Of Boarding :</strong>"
						                																								+"  <hr>"
						                																										+"  </div>"
						                																												+"  <div>"
						        		...
						        		+"      <div style='width: 15.6%;margin-left: .5rem;'>"
						        		+"     <div>"
						        				+"      <strong>"+trainNumber+"</strong><br>"
						        						+"     <hr>"
						        								+" </div>"
						        										+"   <div>"
						        												+"      <strong>"+localDate+" "+localTime+"</strong><br>"
						        														+"     <hr>"
						                		+"   </div>"
						                				+"    <div>"
						                						+"       <strong>"+date+" 2024 </strong><br>"
						                								+"       <hr>"
						                										+"    </div>"
						                												+"    <div>"
						                														+"        <strong>"+date+" 2024 </strong>"
						                																+"        <hr>"
						                																		+"     </div>"
						                																				+"     <div>"
						                																						+"      <strong>"+nextDate+" 2024</strong><br>"
						                																								+"    <hr>"
						                																										+"   </div>"
						                																												+"   <div>"
						                																														+"  <strong>1000 KM</strong><br>"
						                																																+"   <hr>"
						                +"        	   </div>"
						            		+"   </div>"
						        		+" <div style='width: 15.6%;margin-left: .5rem;  color: black ;'>"
						                		       												...
						                		       												+"  <div>"
						                		       														+"    <strong>Scheduled Departure*</strong>"
						                		       																+"    <hr>"
						                		       																		+"   </div>"
						                		       																				+"   <div>"
						                		       																						+"      <strong>Adult :1</strong><br>"
						                		       																								+"     <hr>"
						                		       																										+" </div>"
						                		       																												+"  <div>"
						            		+"      <strong>Insurance(No. of Psng)</strong><br>"
						                		+"      <hr>"
						                		+"    </div>"
						            		 +"  </div>"
						        		+"    <div style='width: 15.6%;margin-left: .5rem;'>"
						            		...
						            		+"    <strong>General</strong><br>"
						                		...
						                		+"  </div>"
						            		+"  <div>"
						            		 +"   <strong>AC 2 Tier (2A)</strong><br>"
						                		+"   <hr>"
						                		+"  </div>"
						            		+"   <div>"
						            		+"   <strong>"+journeyFrom+" </strong><br>"
						            				+"   <hr>"
						                +" </div>"
						            		+"<div>"
						            		+"<strong>"+localDate+" "+localTime+"</strong>"
						                +"    <hr>"
						                		+" </div>"
						            		+"  <div>"
						            		+"    <strong>Chilid: 0</strong><br>"
						                		+"    <hr>"
						                		+" </div>"
						            		+"  <div>"
						            				+"  <strong>1</strong><br><hr>"
						                		+"   </div>"
						            		+" </div>"
						        		+" </div>"
		                +"<div style='width: 100%;'>"
		                ...
		                +" <div style='width:12.9%; margin-left: .7rem;'><strong>"+berth+"</strong><hr></div>    "
		                +" </div>"
		                +" <div  style='width:100%; font-size: .7rem'>"
		                ...
		                +" </div>"
		                +" <div style='display: flex; color: white;margin-top: .2rem; '>"
		                +"    <div style='width:25%; margin-left: .5rem;'><strong>Rs. "+price+"</strong><hr></div>"
		                +"   <div style='width:25%; margin-left: .5rem;'><strong>Rs. 15</strong><hr></div>"
		                +"  <div style='width:25%; margin-left: .5rem;'><strong>	Rs. 0.35</strong><hr></div>"
		                +"  <div style='width:25%; margin-left: .5rem;'><strong>Rs. "+totalPrice+" *</strong><hr></div>  "
		                +"  </div>"
		                +" <div  style='width: 100%;'>"
		                +"    <strong style='color:#0437F2;  margin-left: .5rem;'>Must Read</strong><hr style='margin-top: 0rem;  margin-left: .5rem;'>"
		                +" </div>"
		                +" <div style='display: flex; color: white;margin-top: .2rem; '>"
		                +"  <ul style='color: black; font-size: .7rem;'>"
		                +" <li>"
		                ...
		                +" ID Cards permissible for undertaking journey on reserved tickets."
		                +"  </li>"
		                +" <li>"
		...
		RequestDispatcher dispatcher=request.getRequestDispatcher("2Ac-class-booking.jsp");
