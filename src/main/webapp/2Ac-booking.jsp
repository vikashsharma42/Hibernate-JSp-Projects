...
<%
	...
	int pnr=dummyPnr*23;
	int coaches=random.nextInt(5);
	int dummyCoach=coaches+1;
	String coach="A"+dummyCoach;
	int bearth=random.nextInt(16);
	String status="CNF";
    ...
    TrainDataBase.updateAccClass(trainNumber);
	...
	RequestDispatcher dispatcher=request.getRequestDispatcher("2AcTicketMail.jsp");
