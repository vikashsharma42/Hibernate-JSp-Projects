...
<body onload="getTime();checkButton()">
	<div class="nav_parent" style="margin-top: 0rem">
		...
		<div class="nav_child">
			<div class="nav_Container">
				<ul>
					<li><a class="nav_link1" href="logout.jsp">LOGOUT</a></li>
					<li><strong>WELCOME <%=session.getAttribute("fname")%>
							<%=session.getAttribute("lname")%>(<%=session.getAttribute("username")%>)
					</strong></li>
					...
					<ul>
										...
										<li><img src="images/logo.png"> IRCTC eWallet
											<div class="submenu_child_box">
												...
												<div class="submenu_child">
													<ul>
														<li><a href="pdf/EwalletUserGuide.pdf"
															target="_blank">IRCTC- iPAY User Guide</a></li>
													</ul>
												</div>
											</div>
									</ul>
										...
										<li class="padd">Advertise with us
											<div class="submenu_parent">
												<div class="submenu_childConatiner">
													...
													<div class="submenu_child">
														<ul>
															<li><a href="pdf/Push_Notification.pdf"
																target="_blank">Push Notification</a></li>
														</ul>
													</div>
													<div class="submenu_child">
														<ul>
													...
													<div class="submenu_child">
														<ul>
															<li><a href="pdf/Promotional_SMS.pdf"
																target="_blank">SMS(Promotional)</a></li>
														</ul>
													</div>
													<div class="submenu_child">
														<ul>
						...
						<li><a class="nav_link7">MORE</a>
							<div class="submenu">
								<div class="submenu_box">
									<ul>
										<li><a href="chatBot.jsp" target="_blank">Chat Boat
												as a Service(sas)</a></li>
									</ul>
								</div>
								<div class="submenu_child">
									<ul>
								...
								<div class="submenu_child">
									<ul>
										<li><a href="#" target="_blank">FORGOT ACCOUNT
												DETAILS?</a></li>
									</ul>
								</div>
							</div></li>
